# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-05-19 22:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('-1', '支出'), ('1', '收入')], max_length=1, verbose_name='去向')),
                ('type', models.CharField(choices=[('-1', '支出'), ('1', '收入')], max_length=1, verbose_name='账目类型')),
